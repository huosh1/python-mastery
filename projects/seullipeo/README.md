...
**Permission refusée**
```bash
# Solution: Exécuter avec sudo si nécessaire
sudo python3 main.py --scan --suid
```
...
```bash
# Normal sur systèmes bien configurés
# Tester sur VM volontairement vulnérable
```
...
```bash
# Mode verbeux
python3 main.py --scan --all-modules --verbose

# Logs détaillés
tail -f logs/seullipeo.log

# Shell debug
seullipeo> set DEBUG true
```
...
3. **Commit** les changements (`git commit -am 'Ajout module sudo'`)
4. **Push** vers la branche (`git push origin feature/nouveau-module`)
5. **Créer** une Pull Request

### Développement de Modules

```python
# exploits/nouveau_module.py
...
- **Code** : Suivre PEP 8, commenter le code
- **Tests** : Ajouter des tests unitaires
- **Documentation** : Documenter les nouvelles fonctionnalités
- **Sécurité** : Pas de backdoors ou code malveillant

## 📈 Roadmap

### Version 1.1 (Q2 2025)
- [ ] Module sudo vulnerabilities (CVE-2021-4034, etc.)
- [ ] Module kernel exploits
...
- [ ] Modules réseau/lateral movement
- [ ] Framework de payload
- [ ] Support multi-cibles

## 📞 Support

### 📧 Contact
- **Email** : seullipeo@example.com
- **GitHub** : [Issues](https://github.com/huosh1/seullipeo/issues)
- **Discord** : Serveur communauté (à venir)

### 📚 Ressources
- **Wiki** : [Documentation complète](https://github.com/huosh1/seullipeo/wiki)
- **Exemples** : [Repository d'exemples](https://github.com/huosh1/seullipeo-examples)
- **Vidéos** : [Chaîne YouTube](https://youtube.com/seullipeo) (à venir)
...
```
MIT License - Copyright (c) 2025 Seullipeo Team
```

## 🙏 Remerciements

- **Communauté de sécurité** pour les retours et contributions
- **Projets open source** qui ont inspiré Seullipeo
- **Équipe de test** pour les validations et améliorations
- **LinPEAS, LinEnum** et autres outils similaires pour l'inspiration

---

**Seullipeo (슬리퍼)** - *"L'art de réveiller les privilèges endormis"*

⭐ Si ce projet vous aide, n'hésitez pas à lui donner une étoile !

[![GitHub stars](https://img.shields.io/github/stars/huosh1/seullipeo.svg?style=social&label=Star)](https://github.com/huosh1/seullipeo)
[![GitHub forks](https://img.shields.io/github/forks/huosh1/seullipeo.svg?style=social&label=Fork)](https://github.com/huosh1/seullipeo/fork)
[![GitHub issues](https://img.shields.io/github/issues/huosh1/seullipeo.svg)](https://github.com/huosh1/seullipeo/issues)